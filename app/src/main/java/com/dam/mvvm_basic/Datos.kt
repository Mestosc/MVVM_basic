 ...
 */
enum class EstadosAuxiliares(val txt: String, val func: (cadena: String) -> String) {
    AUX1(txt = "aux1", func = {cadena -> cadena}),
    AUX2(txt = "aux2", func = {cadena -> cadena.lowercase()}),
    AUX3(txt = "aux3", func = {cadena -> cadena.uppercase()}),
}
